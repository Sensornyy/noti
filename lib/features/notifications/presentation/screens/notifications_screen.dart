...
import 'package:noti/features/notifications/presentation/widgets/recurring_list_widget.dart';
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<NotificationsBarBloc, NotificationsBarState>(
          builder: (context, state) {
            return state.when(
              oneTime: () => BlocBuilder<NotificationsBloc, NotificationsState>(
                builder: (context, state) {
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) => BlocProvider(
                                      ...
                                      child: const AddOrEditNotificationScreen(
              ...
              recurring: () => const RecurringListWidget(),
            );
          },
        ),
      ),
